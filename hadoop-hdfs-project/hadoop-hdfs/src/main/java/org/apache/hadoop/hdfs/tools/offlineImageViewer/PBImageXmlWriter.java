...
public final class PBImageXmlWriter {
  ...
  public static final String ERASURE_CODING_SECTION_SCHEMA_PARITY_UNITS =
      "parityUnits";
  public static final String ERASURE_CODING_SECTION_SCHEMA_LOCAL_PARITY_UNITS=
      "localParityUnits";
  ...
  private void dumpErasureCodingPolicy(ErasureCodingPolicyInfo ecPolicyInfo) {
    ...
    o(ERASURE_CODING_SECTION_SCHEMA_LOCAL_PARITY_UNITS,
        schema.getNumLocalParityUnits());
