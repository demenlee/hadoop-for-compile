...
public class BlockInfoStriped extends BlockInfo {
  ...
  public BlockInfoStriped(Block blk, ErasureCodingPolicy ecPolicy) {
    super(blk, (short) (ecPolicy.getNumDataUnits()
            ...
            + ecPolicy.getNumLocalParityUnits()));
  ...
  public short getRealTotalBlockNum() {
    return (short) (getRealDataBlockNum() + getParityBlockNum() + getLocalParityBlockNum());
  }
  ...
  public long spaceConsumed() {
    ...
    return StripedBlockUtil.spaceConsumedByStripedBlock(getNumBytes(),
        ecPolicy.getNumDataUnits(), ecPolicy.getNumParityUnits(),
            ecPolicy.getNumLocalParityUnits(), ecPolicy.getCellSize());
    }
