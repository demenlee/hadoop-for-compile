  ...
  static class AddErasureCodingPolicyOp extends FSEditLogOp {
    ...
    protected void toXml(ContentHandler contentHandler) throws SAXException {
      ...
      if(ecPolicy.getCodecName() != "lrc"){
        ...
        XMLUtils.addSaxString(contentHandler, "LOCALPARITYUNITS",
            Integer.toString(ecPolicy.getNumLocalParityUnits()));
        XMLUtils.addSaxString(contentHandler, "PARITYUNITS",
            Integer.toString(ecPolicy.getNumParityUnits()));
      }
    ...
    void fromXml(Stanza st) throws InvalidXmlException {
      ...
      final int parityUnits;
      final int localParityUnits;
      if(ecPolicy.getCodecName() != "lrc"){
        parityUnits = Integer.parseInt(st.getValue("PARITYUNITS"));
        localParityUnits = 0;
      }else{
        parityUnits = Integer.parseInt(st.getValue("PARITYUNITS"));
        localParityUnits = Integer.parseInt(st.getValue("LOCALPARITYUNITS"));
      }
      ...
      ECSchema schema;
      if (extraOptionNum == 0) {
        schema = new ECSchema(codecName, dataUnits, localParityUnits, parityUnits, null);
      } else {
        ...
        schema = new ECSchema(codecName, dataUnits, localParityUnits, parityUnits, extraOptions);
      }
