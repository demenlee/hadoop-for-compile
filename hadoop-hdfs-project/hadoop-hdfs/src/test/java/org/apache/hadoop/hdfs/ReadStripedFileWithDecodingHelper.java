...
abstract public class ReadStripedFileWithDecodingHelper {
  ...
  protected static final short NUM_LOCAL_PARITY_UNITS =
      (short) EC_POLICY.getNumLocalParityUnits();
  ...
  private static final int NUM_DATANODES = NUM_DATA_UNITS
                                          + NUM_PARITY_UNITS
                                          + NUM_LOCAL_PARITY_UNITS;
