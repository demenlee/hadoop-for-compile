...
public class DFSStripedInputStream extends DFSInputStream {
  ...
  private final short localParityBlkNum;
  private final int groupSize;
  /** the buffer for a complete stripe. */
  private ByteBuffer curStripeBuf;
  private ByteBuffer parityBuf;
  private ByteBuffer localParityBuf;
  ...
  DFSStripedInputStream(DFSClient dfsClient, String src,
    ...
    localParityBlkNum = (short) ecPolicy.getNumLocalParityUnits();
    groupSize = dataBlkNum + parityBlkNum + localParityBlkNum;
  ...
  protected ByteBuffer getLocalParityBuffer() {
    if (localParityBuf == null) {
      localParityBuf = BUFFER_POOL.getBuffer(useDirectBuffer(),
              cellSize * localParityBlkNum);
    }
    localParityBuf.clear();
    return localParityBuf;
  }
