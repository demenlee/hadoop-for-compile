...
public final class RawErasureCoderBenchmark {
  ...
  private static RawErasureEncoder getRawEncoder(int index) throws IOException {
    ...
    encoder.encode(
        ...
        getBufferForInit(BenchData.NUM_PARITY_UNITS
            +BenchData.NUM_LOCAL_PARITY_UNITS, 1, isDirect));
    return encoder;
  }
  ...
  private static class BenchData {
    ...
    public static final int NUM_LOCAL_PARITY_UNITS = OPTIONS.getNumLocalParityUnits();
    ...
    private ByteBuffer[] outputs = new ByteBuffer[NUM_PARITY_UNITS + NUM_LOCAL_PARITY_UNITS];
