...
public final class ErasureCoderOptions {
  ...
  public ErasureCoderOptions(int numDataUnits, int numParityUnits, int numLocalParityUnits) {
    this(numDataUnits, numParityUnits, numLocalParityUnits, false, false);
  }
  ...
  public ErasureCoderOptions(int numDataUnits, int numParityUnits,
    ...
    this.numAllUnits = numDataUnits + numParityUnits + numLocalParityUnits;
  ...
  /**
   * The number of local parity output units for the coding. A unit can be a byte,
   * chunk, buffer or even a block.
   * @return count of parity output units
   */
  public int getNumLocalParityUnits() {
    return numLocalParityUnits;
  }
