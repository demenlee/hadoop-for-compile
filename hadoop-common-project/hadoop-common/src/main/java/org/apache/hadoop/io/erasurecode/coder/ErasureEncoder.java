...
public abstract class ErasureEncoder extends Configured
  ...
  @Override
  public int getNumParityUnits() {    return numParityUnits;  }
  ...
  protected ECBlock[] getOutputBlocks(ECBlockGroup blockGroup) {
    if(blockGroup.getLocalParityBlocks().length != 0){
      return ArrayUtils.concat(blockGroup.getLocalParityBlocks(),blockGroup.getParityBlocks());
    }else {
