...
public class BlockGrouper {
  ...
  /**
   * Get required local parity blocks count in a BlockGroup.
   * @return count of required parity blocks
   */
  public int getRequiredNumLocalParityBlocks() {
    return schema.getNumLocalParityUnits();
  }
  /**
   ...
   * @param dataBlocks Data blocks to compute parity blocks against
   * @param parityBlocks To be computed parity blocks
   * @param localParityBlocks To be computed parity blocks
   * @return
   */
  public ECBlockGroup makeBlockGroup(ECBlock[] dataBlocks,
                                     ECBlock[] parityBlocks, ECBlock[] localParityBlocks) {

    ECBlockGroup blockGroup = new ECBlockGroup(dataBlocks, parityBlocks, localParityBlocks);
    return blockGroup;
  }
  /**
